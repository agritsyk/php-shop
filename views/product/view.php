<?php include ROOT . '/views/layouts/header.php'; ?>
    ...
    <div class="main_bg" xmlns="http://www.w3.org/1999/html">
        <div class="wrap">
            <div class="main">
                <!-- start content -->
                <div class="single">
...
<!--                                        </div>-->
                                        <div class="product-image">
                                            <img src="<?php echo Product::getImage($productItem['id']); ?>" alt="Women Shorts" title="Women Shorts" />
<!--                                            <a class="cs-fancybox-thumbs cloud-zoom" rel="adjustX:30,adjustY:0,position:'right',tint:'#202020',tintOpacity:0.5,smoothMove:2,showTitle:true,titleOpacity:0.5" data-fancybox-group="thumb" href="/template/images/0001-2.jpg" title="Women Shorts" alt="Women Shorts">-->
<!--                                                -->
<!--                                            </a>-->
                                        </div>
<!--                                        <script type="text/javascript">-->
<!--                                            var prodGallery = jQblvg.parseJSON('{"prod_1":{"main":{"orig":"/template/images/0001-2.jpg","main":"/template/images/large/0001-2.jpg","thumb":"/template/images/small/0001-2.jpg","label":""},"gallery":{"item_0":{"orig":"/template/images/0001-2.jpg","main":"/template/images/large/0001-2.jpg","thumb":"/template/images/small/0001-2.jpg","label":""},"item_1":{"orig":"/template/images/0001-1.jpg","main":"/template/images/large/0001-1.jpg","thumb":"/template/images/small/0001-1.jpg","label":""},"item_2":{"orig":"/template/images/0001-5.jpg","main":"/template/images/large/0001-5.jpg","thumb":"/template/images/small/0001-5.jpg","label":""},"item_3":{"orig":"/template/images/0001-3.jpg","main":"/template/images/large/0001-3.jpg","thumb":"/template/images/small/0001-3.jpg","label":""},"item_4":{"orig":"/template/images/0001-4.jpg","main":"/template/images/large/0001-4.jpg","thumb":"/template/images/small/0001-4.jpg","label":""}},"type":"simple","video":false}}'),-->
...
<!--                                        </script>-->
                        ...
                        <div class="span1_of_1_des">
                            <div class="desc1">
                                ...
                                <p>Manufacturer: <?php echo $productItem['brand'];?>.
                                <p>
                                    Code: <?php echo $productItem['code'];?>.
                                    Еще текст, потому что едет верстка шаблона. Бла бла бла :)
                                </p>
<!--                                <h5>$ --><?php //echo $productItem['price']; ?><!--<a href="#">click for offer</a></h5>-->
                                <div class="available">
...
<!--                                    </ul>-->
                                    <div class="btn_form">
                                        <form>
                                            <a class="add-to-cart" data-id="<?php echo $productItem['id']; ?>"
                                               style="padding: 0;" href="/cart/addAjax/<?php echo $productItem['id']; ?>">
...
<!--                                    <span class="span_right"><a href="#">login to save in wishlist </a></span>-->
                                ...
                                <div class="share-desc">
                                    <div class="share">
                                        <h4>Share Product :</h4>
                                        <ul class="share_nav">
                                            <li><a href="#"><img src="/template/images/facebook.png" title="facebook"></a></li>
                                            <li><a href="#"><img src="/template/images/twitter.png" title="Twiiter"></a></li>
                                            <li><a href="#"><img src="/template/images/rss.png" title="Rss"></a></li>
                                            <li><a href="#"><img src="/template/images/gpluse.png" title="Google+"></a></li>
                                        </ul>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                        ...
                        <section class="tabs">
                            ...
                            <div class="content">
                                <div class="content-1">
                                    <p class="para top"><span>LOREM IPSUM</span> <?php echo $productItem['description']; ?></p>
                                    <ul>
                                        <li>Research</li>
                                ...
                                <div class="content-3">
                                    <p class="para top"><span>LOREM IPSUM</span> There are many variations of passages
                        ...
                        <div class="sellers">
                            ...
                            <div class="banner-wrap bottom_banner color_link">
                                <a href="#" class="main_link">
                                    <figure><img src="/template/images/delivery.png" alt=""></figure>
    ...
    <script>
        $(document).ready(function() {
            var contentHeight = $('.content-1').height();
            $('.content').css('min-height', contentHeight+20);
        });
    </script>
